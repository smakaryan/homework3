...
data1 = quandl.get("FRED/GDP", authtoken = "bsbL4UtTxbdZxNtyey_z")
data2 = quandl.get("WIKI/GOOGL", authtoken = "bsbL4UtTxbdZxNtyey_z")
data3 = quandl.get("BCHARTS/ABUCOINSUSD", authtoken = "bsbL4UtTxbdZxNtyey_z")
